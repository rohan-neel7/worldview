 ...
 *
 * Configurable hazard-specific correlation parameters and policies.
 *
 ...
 *   - Configurable candidate envelopes and similarity weights with documented rationale.
 */
...
export const CORRELATION_RULES = Object.freeze({
  EARTHQUAKE: {
    ...
    rationale:
      'WORLDVIEW CORRELATION HEURISTICS: USGS / GDACS teleseismic epicentral uncertainty is typically within 50-100km; mainshocks register across networks within minutes. Magnitude delta > 0.3 indicates calibration disagreement.',
  ...
  WILDFIRE: {
    ...
    rationale:
      'WORLDVIEW CORRELATION HEURISTICS: VIIRS/MODIS active fire pixels within 25km represent a continuous or advancing wildfire complex across satellite orbital overpass intervals (approx 6-12 hours).',
  ...
  FLOOD: {
    ...
    rationale:
      'WORLDVIEW CORRELATION HEURISTICS: Meso-beta scale convective precipitation cells and micro-watershed runoff basins typically correlate within 35km radius over 24h antecedent rainfall accumulation.',
  ...
  CYCLONE: {
    ...
    rationale:
      'WORLDVIEW CORRELATION HEURISTICS: Tropical cyclonic outer storm circulation and destructive wind radii span 200-500km; tracking bulletins track multi-day cyclogenesis over 48h windows.',
